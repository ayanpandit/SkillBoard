        ...
        <div className="text-center space-y-6">
          <div>
            ...
            <div className="flex justify-center space-x-6">
              ...
              <a href="https://www.instagram.com/your_instagram_handle/" target="_blank" rel="noopener noreferrer" className="p-3 bg-slate-700 hover:bg-pink-600 text-slate-300 hover:text-white rounded-full transition-all duration-300 transform hover:scale-110" aria-label="Instagram Profile">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-sm text-slate-500 border-t border-slate-700 pt-4">
            ...
            <p>© 2025 Code Profile Analyzer.</p>
          </div>
        </div>
      </footer>
    </div>);
